...
// Create a queue to store the positions we still need to explore
const queue = [];

// Create a set to store the positions we've already visited
const visited = new Set();

// Keep track of the distance to each position from the starting point
...
// Add the starting position to the queue and visited set, and set its distance to 0
queue.push(startPos);
...
// Print the distance to the end position
console.log(distances.get(endPos.toString()));
